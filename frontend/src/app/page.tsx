...
export default function Home() {
  return (
    ...
    <div className="min-h-screen flex flex-col items-center bg-black text-white relative overflow-hidden">
      {/* Hero Section */}
      {/* <CursorReveal /> */}
      <section className="w-full py-24 flex flex-col items-center text-white relative overflow-hidden" style={{ background: "url('/wave1.jpg') center center / cover no-repeat, linear-gradient(to right, #18181b, #27272a)" }}>
      ...
      <main className="w-full max-w-7xl flex flex-col gap-16 px-4 py-16">
        <section className="grid gap-8 sm:grid-cols-2 md:grid-cols-4">
          <Card className="shadow-lg border-0 bg-zinc-900 text-white">
            <CardHeader>
              <CardTitle>Marketplace</CardTitle>
            </CardHeader>
            <CardContent>
              Browse and connect with a wide range of chemical suppliers and products.
            </CardContent>
          </Card>
          <Card className="shadow-lg border-0 bg-zinc-900 text-white">
            <CardHeader>
            ...
            <CardContent>
              Access your account, manage your profile, and track your activity.
            </CardContent>
          </Card>
          <Card className="shadow-lg border-0 bg-zinc-900 text-white">
            <CardHeader>
            ...
            <CardContent>
              Fill out demand forecasting forms, add chemicals, and receive real-time quotations.
            </CardContent>
          </Card>
          <Card className="shadow-lg border-0 bg-zinc-900 text-white">
            <CardHeader>
            ...
            <CardContent>
              Get AI-driven analytics and up-to-date market trends to make informed decisions.
            </CardContent>
          </Card>
        </section>
